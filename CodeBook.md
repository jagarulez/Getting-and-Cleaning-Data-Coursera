...
-----------------------
The following lines are based on the files README.txt, features.txt and features_info.txt that I download in the folder UCI HAR Dataset. There you will find the follow description:
